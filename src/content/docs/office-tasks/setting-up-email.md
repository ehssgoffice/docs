...
Webmail က အီးမေးကိုအင်တာနက်ဘရောက်ဇာကနေ တိုက်ရိုက်ဝင်ကြည့်တာဖြစ်ပါတယ်။ မေးလ်ဆာဗာပေါ်မှာသိမ်းထားတဲ့ အီးမေးလ်တွေကို အင်တာနက်ရတဲ့အချိန်မှာ ဖတ်ခြင်း၊ ပို့ခြင်းပြုလုပ်နိုင်ပြီး အသုံးပြုနေတဲ့ကွန်ပြူတာ (သို့) မိုဘိုင်းစက်ပစ္စည်းထဲမှာ သိမ်းဆည်းထားခြင်းမရှိပါဘူး။ အင်တာနက်နဲ့ ဘရောက်ဇာရှိတာနဲ့ ဝင်သုံးလို့ရတာမို့လို့ ကွန်ပြူတာဖြစ်ဖြစ်၊ ဖုန်း/တက်ဘလက်မှာပဲဖြစ်ဖြစ် အသုံးပြုပုံချင်းအတူတူဖြစ်ပါတယ်။ အားနည်းချက်ကတော့ အင်တာနက်မရရင် အသုံးမပြုနိုင်တော့ဘဲ လက်ခံလည်းမကျန်ခဲ့တာကြောင့် အင်တာနက်မရတဲ့အချိန် အရင်ကအီးမေးလ်တွေပြန်ကြည့်လို့မရနိုင်ပါဘူး။ အီးမေးလ်အသစ်ဝင်လာတဲ့အခါမှာလည်း notification တက်မှာမဟုတ်ပါဘူး။
...
## Web Mail
အလွယ်ဆုံးနည်းလမ်းဖြစ်ပါတယ်။ အီးမေးလ်ဒိုမိန်းရဲ့နောက်မှာ port နံပါတ် 2096 ကို ကော်လံခံပြီး ဘရောက်ဇာလိပ်စာမှာထည့်လိုက်ရုံနဲ့ web mail မှာလွယ်လွယ်ကူကူအီးမေးလ်သုံးနိုင်မှာဖြစ်ပါတယ်။ ဥပမာအီးမေးလ်ဒိုမိန်းက `ehssg.org` ဆိုရင် `ehssg.org:2096` လို့ထည့်ရမှာဖြစ်ပါတယ်။
:::note
...
:::
![Webmail Login](../../../assets/office-tasks/using-email/webmail-login.png)
