...
![Add Chrome Profile](../../../assets/office-tasks/using-email/google-workspace-add-profile.png)

အောက်ဆုံးရှိ **Add** ကိုနှိပ်ပါ
...
![Gmail iOS Add Account](../../../assets/office-tasks/using-email/gmail-ios-add-account.png)

**Google** ကိုရွေးပါ၊ **Continue** ဆက်နှိပ်ပါ
